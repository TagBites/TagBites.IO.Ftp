...
internal class FtpFileSystemOperations(FtpConnectionConfig connectionConfig) :
    ...
    IDisposable
{
    ...
    private class LinkInfo(FtpFileSystemOperations owner, string fullName, bool isDirectory)
        : IFileLinkInfo
    {
        private FileHash? _hash;

        private FtpFileSystemOperations Owner { get; } = owner;
